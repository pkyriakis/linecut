...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean ViewDemo = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ViewDemo == true) {
            ...
            if (currentUser == null){ //not signed in; show splash screen
                ...
                // need to differentiate later; if client redirect to user dashboard; if vendor
                // to vendor dashboard; if waiter to waiter dashboard
                mAuth.signOut();
                finish();
            }
